...
pool = ConnectionPool(conninfo=settings.DATABASE_APP_URL, min_size=1, max_size=10, open=False)
async_pool = AsyncConnectionPool(conninfo=settings.DATABASE_APP_URL, min_size=1, max_size=10, open=False)
